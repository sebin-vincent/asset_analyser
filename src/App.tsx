...
const REPO_URL = 'https://github.com/sebin-vincent/asset_analyser';

// `noopener` is what stops the opened tab from reaching back through window.opener; `noreferrer`
// is belt-and-braces given Referrer-Policy is already strict-origin-when-cross-origin.
function GithubLink() {
  return (
    <a
      href={REPO_URL}
      ...
      className="rounded-md p-1.5 text-ink-3 transition-colors hover:text-ink focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-acc"
    >
